...
export function DatePicker({ selectedDate, onSelectDate, primaryColor, heading = "Pick a date", helperText = "Next 7 days" }: DatePickerProps) {
  return (
    <section className="rounded-3xl border border-[#E5E1DA] bg-white p-5 shadow-sm sm:p-6">
      <div className="mb-4 flex items-end justify-between gap-4">
        ...
        <p className="text-sm text-[#78716C]">{helperText}</p>
      </div>
